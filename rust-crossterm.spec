...
BuildRequires:  (crate(crossterm_cursor/default) >= 0.2.3 with crate(crossterm_cursor/default) < 0.3.0)
BuildRequires:  (crate(crossterm_input/default) >= 0.3.5 with crate(crossterm_input/default) < 0.4.0)
BuildRequires:  (crate(crossterm_screen/default) >= 0.2.3 with crate(crossterm_screen/default) < 0.3.0)
BuildRequires:  (crate(crossterm_style/default) >= 0.3.3 with crate(crossterm_style/default) < 0.4.0)
BuildRequires:  (crate(crossterm_terminal/default) >= 0.2.4 with crate(crossterm_terminal/default) < 0.3.0)
BuildRequires:  (crate(crossterm_utils/default) >= 0.2.3 with crate(crossterm_utils/default) < 0.3.0)
